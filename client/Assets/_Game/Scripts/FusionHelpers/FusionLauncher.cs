...
namespace BeamableExample.FusionHelpers
{
	/// <summary>
	...
	public class FusionLauncher : MonoBehaviour, INetworkRunnerCallbacks
	{
		...
		private NetworkEvents _netEvents;
			...
			Action<NetworkRunner, PlayerRef> onDespawnPlayer)
		{
			...
			SetConnectionStatus(ConnectionStatus.Connecting, "Launch");
			...
			// TODO:: Could we get this number from the beamable room info.
			int playerCount = 200;
		...
		public void OnPlayerJoined(NetworkRunner runner, PlayerRef player)
		{
			...
			SetConnectionStatus(ConnectionStatus.Connected, "OnPlayerJoined");
		}
		...
		{
			Debug.LogFormat("FusionLauncher OnPlayerLeft({0})", player);

			_despawnPlayerCallback(runner, player);

			SetConnectionStatus(_status, "OnPlayerLeft");
		}
		...
		public void OnShutdown(NetworkRunner runner, ShutdownReason shutdownReason)
		{
			...
			RedLightManager redlightManager = FindObjectOfType<RedLightManager>();
			if (redlightManager != null)
				redlightManager.StopGame();
