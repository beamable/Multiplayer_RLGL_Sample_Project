...
namespace BeamableExample.RedlightGreenLight.Character
{
	...
	public abstract class AdvancedPlayer : BasePlayer
	{
		// PRIVATE MEMBERS
		...
		private void EarlyFixedUpdate()
		{
			...
			// At this point, PlayerInput.OnBeforeUpdate() and PlayerInput.OnInput() were already called so we have the input ready to be polled.

			Input.OnFixedUpdate();

			// At this point, Input.FixedInput is set and can be processed by derived classes.
