...
namespace BeamableExample.RedlightGreenLight
{
    public class CountdownManager : MonoBehaviour
    {
        ...
        [SerializeField] private Image _countdownRadial;
        ...
        public void Reset()
        {
            ...
            _countdownRadial.gameObject.SetActive(false);

            // _countdownRadial.transform.localScale = Vector3.zero;
        ...
        public IEnumerator Countdown(Callback callback)
        {
            ...
            _countdownRadial.gameObject.SetActive(true);
            ...
            while (_countdownTimer > 0)
            {
                ...
                if (t >= 0)
                {
                    ...
                    // _countdownRadial.transform.localScale = Vector3.one * t;
                    _countdownRadial.fillAmount = x;
                }
